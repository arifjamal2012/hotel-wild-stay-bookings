...
function SalesChart({ bookings, numDays}) {
  ...
  return <StyledSalesChart>
    ...
    <ResponsiveContainer height={300} width="100%">
      <AreaChart data={data}>
        <XAxis dataKey="label" tick={{fill: colors.text}} tickLine = {{ strike: colors.text }} />
        <YAxis unit="$" tick={{fill: colors.text}} tickLine = {{ strike: colors.text }} />
        ...
        <Area dataKey="extrasSales" type="monotone" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} strokeWidth={2} name="Extra sales" unit="$" ></Area>
      </AreaChart>
    </ResponsiveContainer>
  </StyledSalesChart>
}
